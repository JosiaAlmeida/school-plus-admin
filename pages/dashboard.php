                      ...
                      ?>
                                                <tr>
                                                        ...
                                                        <div class="d-flex px-2 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                ...
                                                                <p class="text-xs text-secondary mb-0">
                                                                    <?=$value['escola_antiga']?></p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <p class="text-xs font-weight-bold mb-0"><?=$value['Curso']?>
                                                        </p>
                                                    </td>
                                                    </td>
                                                    <td>
                                                        <p class="text-xs font-weight-bold mb-0"><?=$value['telefone']?>
                                                        </p>
                                                    </td>
                                                    </td>
                                                    <td>
                                                        <p class="text-xs font-weight-bold mb-0"><?=$value['idade']?>
                                                        </p>
                                                    </td>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="align-middle text-center text-sm">
                                                        <span
                                                            class="badge badge-sm bg-gradient-success"><?=$value['selecionado']?'Aprovado':'Reprovado' ?></span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <span
                                                            class="text-secondary text-xs font-weight-bold"><?=$value['media']?></span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <button class="btn" type="submit" value="<?=$value['id']?>"
                                                            name="deletar">
