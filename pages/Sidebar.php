<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="http://localhost:8080/index.php" target="_blank">
            <img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold text-white">School Plus</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white " href="../pages/dashboard.php">
                    ...
                    <span class="nav-link-text ms-1">Estatistica</span>
                </a>
            </li>
            <li class="nav-item">
