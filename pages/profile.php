          ...
          <div class="row">
            <div class="col-sm-12 col-md-6 col-xl-6">
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  <p class="text-sm">
                    Olá! School Plus é uma escola de ensino intensivo para formar os melhores alunos com os melhores comportamentos, notas, atitudes e delicadesa  
                  </p>
            ...
            <div class="col-sm-12 col-md-6 col-xl-6">
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  <ul class="list-group">
                    <li class="list-group-item border-0 d-flex align-items-center justify-content-center px-0 mb-2 pt-0">
                    ...
                    <li class="list-group-item border-0 d-flex align-items-center justify-content-center px-0 mb-2 pt-0">
                      ...
                      <div class="d-flex align-items-start flex-column justify-content-center">
                        ...
                        <p class="mb-0 text-xs">IG12A | Número 08</p>
                      </div>
                    </li>
                    <li class="list-group-item border-0 d-flex align-items-center justify-content-center px-0 mb-2">
                      ...
                      <div class="d-flex align-items-start flex-column justify-content-center">
                        ...
                        <p class="mb-0 text-xs">IG12A | Número 11</p>
                      </div>
                    </li>
                    <li class="list-group-item border-0 d-flex align-items-center justify-content-center px-0 mb-2">
                      <div class="avatar me-3">
