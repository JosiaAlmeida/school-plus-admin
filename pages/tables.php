                      ...
                      ?>
                            ...
                            ?>
                                                        <input class="form-check-input ms-auto"
                                                            onchange="(v)=>handleChange(v.target.value)" type="checkbox"
                            ...
                            ?>
                                                ...
                                                <td>
                                                    <button class="btn" type="submit" value="<?=$value['id']?>"
                                                        name="deletar">
                                                        <i onclick="<?php $deleteId = $value['id'];?>"
                                                            class="material-icons opacity-10">delete</i>
                                                    </button>
                                                </td>
                                            </tr>
                                            <?php endforeach;
...
window.addEventListener('submit', () => {
    location.href = "http://localhost:8000/pages/dashboard.php"
})
</script>
